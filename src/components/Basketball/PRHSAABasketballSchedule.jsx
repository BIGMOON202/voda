...
import { BasketballScheduleRow } from "./BasketballScheduleRow";
...
export const PRHSAABasketballSchedule = ({ selectedGender, selectedYear }) => {
  const { teamsData, schedulesData, error } =
    PRHSAABasketballStanding_Firestoreoverall();
