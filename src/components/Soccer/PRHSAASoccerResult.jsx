...
export const PRHSAASoccerResult = ({ selectedGender, selectedYear }) => {
  const { teamsData, schedulesData } = PRHSAASoccerStanding_Firestoreoverall();
        ...
        {filteredDocuments.map((result, index) => {
          ...
          return (
            <SoccerResultCard
              ...
              penaltyScore={getPenaltyScore(result.Penalty)}
              Date={result.Date}
            />
          );
        })}
