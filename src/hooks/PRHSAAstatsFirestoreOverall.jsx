...
const PRHSAAstatsFirestoreOverall = () => {
  ...
  const fetchVolleyballTeams = () => {
    const q = query(collection(db, "PRHSAAVolleyballTeams"));
    return onSnapshot(
      q,
      (querySnapshot) => {
        const teamsData = [];
  ...
  const fetchBasketballTeams = () => {
    const q = query(collection(db, "PRHSAABasketballTeams"));
    return onSnapshot(
      q,
      (querySnapshot) => {
        const teamsData = [];
  ...
  const fetchSoccerTeams = () => {
    const q = query(collection(db, "PRHSAASoccerTeams"));
    return onSnapshot(
      q,
      (querySnapshot) => {
        const teamsData = [];
  ...
  const fetchVolleyballSchedules = () => {
    const q = query(collection(db, "PRHSAAVolleyballSchedules"));
    return onSnapshot(
      q,
      (querySnapshot) => {
        const schedulesData = [];
  ...
  const fetchBasketballSchedules = () => {
    const q = query(collection(db, "PRHSAABasketballSchedules"));
    return onSnapshot(
      q,
      (querySnapshot) => {
        const schedulesData = [];
  ...
  const fetchSoccerSchedules = () => {
    const q = query(collection(db, "PRHSAASoccerSchedules"));
    return onSnapshot(
      q,
      (querySnapshot) => {
        const schedulesData = [];
...
export { PRHSAAstatsFirestoreOverall };
